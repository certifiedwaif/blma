...
#' @export
cva <- function(vy_in, mX_in, prior, modelprior, modelpriorvec_in, mGamma_in, bUnique = TRUE, lambda = 1.) {
    .Call('_blma_cva', PACKAGE = 'blma', vy_in, mX_in, prior, modelprior, modelpriorvec_in, mGamma_in, bUnique, lambda)
}
