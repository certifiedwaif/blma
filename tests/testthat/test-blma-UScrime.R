...
test_that("UScrime produces correct results liang_g_n_appell", {
	...
	vy <- UScrime$vy
	mX <- UScrime$mX
	result <- blma(vy, mX, prior="liang_g_n_appell", modelprior="uniform", cores=144)
	expect_equal(result$vinclusion_prob, c(
...
test_that("UScrime produces correct results liang_g_n_quad", {
	...
	vy <- UScrime$vy
	mX <- UScrime$mX
	result <- blma(vy, mX, prior="liang_g_n_quad", modelprior="uniform", cores=144)
	expect_equal(result$vinclusion_prob, c(
...
test_that("UScrime produces correct results robust_bayarri1", {
	...
	vy <- UScrime$vy
	mX <- UScrime$mX
	result <- blma(vy, mX, prior="robust_bayarri1", modelprior="uniform", cores=144)
	expect_equal(result$vinclusion_prob, c(
...
test_that("UScrime produces correct results robust_bayarri2", {
	...
	vy <- UScrime$vy
	mX <- UScrime$mX
	result <- blma(vy, mX, prior="robust_bayarri2", modelprior="uniform", cores=144)
	expect_equal(result$vinclusion_prob, c(
...
test_that("UScrime produces correct results zellner_siow_gauss_laguerre", {
	...
	vy <- UScrime$vy
	mX <- UScrime$mX
	result <- blma(vy, mX, prior="zellner_siow_gauss_laguerre", modelprior="uniform", cores=144)
	expect_equal(result$vinclusion_prob, c(
...
test_that("UScrime produces correct results modelprior beta-binomial", {
	...
	mX <- UScrime$mX
	p <- ncol(mX)
	result <- blma(vy, mX, prior="BIC", modelprior="beta-binomial", modelpriorvec = c(1, p), cores=144)
	expect_equal(result$vinclusion_prob, c(
